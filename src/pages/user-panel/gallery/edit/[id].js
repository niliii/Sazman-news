...
export default function AddAds() {
    ...
    const dataFetch = async () => {
        const res = await fetch(`${process.env.LOCAL_URL}/api/user-panel/gallery/edit/${router.query.id}`)
    ...
    const submitHandler = async (event) => {
        ...
        if (titleError || statusError) {
            ...
            try {
                const res = await axios.put(`${process.env.LOCAL_URL}/api/user-panel/gallery/edit/${router.query.id}`, formData, {
                        headers: {
